...
import ecommecre.model.request.ProductFilter;
import ecommecre.model.request.ProductRequest;
import ecommecre.repository.BrandRepository;
import ecommecre.repository.CategoryRepository;
import ecommecre.repository.MaterialRepository;
import ecommecre.repository.OriginRepository;
import ecommecre.repository.ProductRepository;
import ecommecre.repository.StylesRepository;
import ecommecre.service.cloud.CloudinaryImageService;
import ecommecre.service.serviceinterface.IPanigationWithFIllter;
import ecommecre.service.serviceinterface.PanigationInterface;
...
public class ProductService implements PanigationInterface<Product>, IPanigationWithFIllter<Product, ProductFilter> {
    ...
    public List<Product> filterProducts(List<Long> selectedBrands, List<Long> selectedScarfTypes,
        ...
        List<Product> filteredProducts = productRepository.findByFilters(selectedBrands, selectedScarfTypes,
                selectedColors);
