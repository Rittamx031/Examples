...
import ecommecre.security.repo.AccountInforRepository;
import ecommecre.security.repo.EmployeeInfoRepository;
import ecommecre.security.service.AccountInfoService;
import ecommecre.security.service.EmployeInfoService;
...
public class SpringSecurityConfig {
  ...
  SecurityFilterChain filterChain(HttpSecurity http, AuthenticationManager authManager)
    ...
    http
        ...
        .authorizeHttpRequests(authorize -> {
          authorize.requestMatchers("/user/passwordchange", "/user/change_password","/shop/profile").hasAnyAuthority("USER");
        })
        .authorizeHttpRequests(authorize -> {
